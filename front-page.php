...
<main id="primary" class="site-main">
      ...
      <?php 
        include('front-page-intro.php');
        include('front-page-info-block.php');
        include('front-page-three-cities.php');
        include('front-page-divider-one.php');
      ?>
...
<rect x="171" class="st0-o w" width="84.2" height="29.1"/>
	...
	<rect x="416.6" y="529.4" class="st0-o" width="45.9" height="29.5"/>
      ...
      <?php 
        include('front-page-divider-two.php');
        include('front-page-ecosystem.php');
      ?>
